...
import static im.cave.ms.client.character.temp.CharacterTemporaryStat.SetBaseDamage;
import static im.cave.ms.enums.BaseStat.dex;
import static im.cave.ms.enums.BaseStat.inte;
import static im.cave.ms.enums.BaseStat.luk;
import static im.cave.ms.enums.BaseStat.mad;
import static im.cave.ms.enums.BaseStat.pad;
import static im.cave.ms.enums.BaseStat.str;
...
public class DamageCalc {
    ...
    public DamageCalc(MapleCharacter chr, int seed1, int seed2, int seed3) {
        this.seed1 = seed1;
        this.seed2 = seed2;
        this.seed3 = seed3;
        this.chr = chr;
    ...
    public long calcPDamageForPvM(int skillID, byte slv) {
        ...
        int weaponType = ItemConstants.getWeaponType(chr.getEquippedEquip(BodyPart.Weapon).getItemId());
