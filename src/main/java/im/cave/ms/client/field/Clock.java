...
public class Clock {
    ...
    private static OutPacket stopWatch(int seconds) {
        ...
        outPacket.writeShort(SendOpcode.CLOCK.getValue());
        outPacket.write(ClockType.StopWatch.getVal());
        outPacket.writeInt(seconds * 1000);
        return outPacket;
    }
    ...
    private static OutPacket secondsClock(int seconds) {
        OutPacket outPacket = new OutPacket();
        outPacket.writeShort(SendOpcode.CLOCK.getValue());
        outPacket.write(ClockType.SecondsClock.getVal());
        outPacket.writeInt(seconds);
        return outPacket;
    }
