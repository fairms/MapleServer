...
public enum DimensionalMirror {
    ...
    FIGHT_FOR_AZWAN(2, "阿斯旺解放战", "Eliminate the remainder of Hilla's forces in the Azwan area.", 120, 0, 7892, new int[]{1162009, 2430690, 1032136}, false),
    EVOLUTION_LAB(3, "进化系统研究所", "Ready for the wonders of the Evolution System?", 105, 1801, 1819, new int[]{1162013, 4001832, 2431935, 2431936}, false),
    DIMENSION_INVASION(4, "次元入侵", "Defeat the invaders before it's too late!", 140, 0, 31836, new int[]{1082488, 1082489, 1142527, 1142528, 1142529, 1142530}, false),
    CRIMSONHEART_CASTLE(5, "克林逊森林城堡", "A message from Masteria... What's going on?", 130, 31241, 31265, new int[]{1142619, 2431935, 2431936}, false),
    GRAND_ATHENAEUM(6, 302000000, "次元图书馆", "Head to the Grand Athenaeum to get a glipse of the past.", 100, 0, 32670, new int[]{1122263, 2431892}, false),
    PARTY_QUEST_ENTRANCE(7, 910002000, "组队任务综合入场", "It's more fun when you play with friends! Create a party \nto participate in a special mission.", 50, 0, 7887, new int[]{1003762, 1022073, 1132013, 1022175, 1902048, 2432131}, true),
    TOWER_OF_OZ(8, "起源之塔", "Conquer the underwater tower known as the Tower of Oz to help Alicia's Soul.", 140, 42009, 7839, new int[]{2028263, 2432465}, false),
    FRIENDSTORY(9, 100000004, "好友故事", "Experience FriendStory, the first spin-off of MapleStory!", 100, 32707, 33041, new int[]{1182079, 3015119, 3010875, 2432776, 2432788}, false),
    MONSTER_PARK_REBORN(10, "怪物公园REBORN", "Massive EXP and different daily rewards await you!", 105, 0, 7900, new int[]{2434746, 2434747, 2434748, 2434749, 2434750, 2434751, 2434745}, false),
    ROOT_ABYSS(11, "鲁塔比斯", "Battle the seal guardians to weaken them. \nThe future of Maple World is in your hands.", 125, 30000, 30028, new int[]{1003715, 1003716, 1003717, 1003718}, false),
    URSUS(12, "乌鲁斯", "Think you can take on Ursus the Destroyer?", 100, 0, 33553, new int[]{3015279, 2434509, 2434389, 3700334, 1142879}, true),
    // 鬼魂公园 id 13
...
//    ALISHAN(502, 749080900, 1, "枫叶山丘", "Do you want to move to Alishan?", 33, 55234, 55255, new int[]{1202160, 2434004}, false),
    ...
    MOMIJIGAOKA(506, 807000000, 4, "阿布鲁大本营", "Do you want to move to Momijigaoka?", 13, 0, 7844, new int[]{}, false);
