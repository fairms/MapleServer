...
public enum RecvOpcode {
    ...
    DELETE_CHAR(0x84),
    DELETE_CHAR_CONFIRM(0x85),
    CANCEL_DELETE_CHAR(0x86),
    PONG(0x9C),
    CPONG(0x9D),
    ERROR_PACKET(0x9F),
    CLIENT_START(0xA2),
    AFTER_CREATE_CHAR(0xAB),
    ...
    USER_SELECT_ANDROID(0x230),
    COMBO_KILL_CHECK(0x233),
    USER_SOUL_EFFECT_REQUEST(0x24A),
    USER_AVATAR_MODIFY_COUPON_USE_REQUEST(0x27E),
    PET_MOVE(0x280),
    PET_ACTION_SPEAK(0x281),
    PET_SET_EXCEPTION_LIST(0x285),
    PET_FOOD_ITEM_USE_REQUEST(0x286),
    SUMMON_MOVE(0x291),
    ANDROID_MOVE(0x2A7),
    CHANGE_QUICKSLOT(0x2AE),
    SEND_MAPLE_MESSAGE(0x2B7),
    UPDATE_TICK(0x330),
    SIGN_IN(0x34A),
    SKILL_COMMAND_LOCK(0x34D),
    UNITY_PORTAL_REQUEST(0x355),
    POTION_POT_USE_REQUEST(0x3B6),
    POTION_POT_ADD_REQUEST(0x3B7),
    POTION_POT_OPTION_SET_REQUEST(0x3B8),
    POTION_POT_INC_REQUEST(0x3B9),
