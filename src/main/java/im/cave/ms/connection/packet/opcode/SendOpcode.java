...
public enum SendOpcode {
    ...
    SHOW_ITEM_MEMORIAL_EFFECT(0x2B9), //唯一魔方 8F 1D 00 00 01 8A 3D 4D 00 00 00 00 00 00 00 00 00
    ...
    OPEN_UI(0x383),//
    CLOSE_UI(0x384),//
    OPEN_UI_WITH_OPTION(0x385),//
    SET_DIRECTION_MODE(0x386),//393-7
    SET_IN_GAME_DIRECTION_MODE(0x387),//
    SET_STAND_ALONE_MODE(0x388),//395-7
