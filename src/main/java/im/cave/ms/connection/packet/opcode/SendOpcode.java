...
public enum SendOpcode {
    ...
    SET_ACCOUNT_INFO(0x133), //00 00 00 00 00 00 00 00  06 00 71 71 71 71 71 71
    //
    //
    ...
    CHAT(0x2B0),
    UNK_2B1(0x2B1),
    BLACK_BOARD(0x2B2),//2b9 - a //小黑板
    //
    //
    SHOW_ITEM_UPGRADE_EFFECT(0x2B5),
    SHOW_ITEM_SKILL_SOCKET_UPGRADE_EFFECT(0x2B6),
    SHOW_ITEM_SKILL_OPTION_UPGRADE_EFFECT(0x2B7),
    SHOW_ITEM_RELEASE_EFFECT(0x2B8),//
    //
    //
    SHOW_CUBE_EFFECT(0x2BB), //唯一魔方 8F 1D 00 00  01  8A 3D 4D 00 00 00 00 00 00 00 00 00
    SHOW_ITEM_ADDITIONAL_RELEASE_EFFECT(0x2BC), //8F 1D 00 00 char Id| 01 | 64 3F 4D 00 itemId|00 00 00 00 00 00 00 00
    //
    //
    //
    //
    ADDITIONAL_CUBE_RESULT(0x2C1),
    //
    //
    //
    //
